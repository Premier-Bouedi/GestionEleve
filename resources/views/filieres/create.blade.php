...
<body class="bg-gray-100 p-10">
    <div class="max-w-xl mx-auto bg-white p-8 rounded-xl shadow-lg">
        <div class="flex items-center justify-between mb-8">
            <h1 class="text-3xl font-extrabold text-gray-800">Ajouter une filière</h1>
        ...
        <form action="{{ route('filieres.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="nom_filiere" class="w-full border-gray-300 border p-3 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition" placeholder="Ex: Informatique de Gestion" required>
            </div>
